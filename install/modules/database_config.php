...
if (isset($_GET['db_error'])) {
    echo '<div class="alert alert-danger">' . urldecode($_GET['db_error']) . '</div>';
} ?>

<?php
$params = ['db_host' => 'localhost', 'db_port' => '', 'db_username' => '', 'db_password' => '', 'db_name' => ''];
...
<form name="db_config" id="db_config" action="index.php?step=keruycrm_config&lng=<?php
