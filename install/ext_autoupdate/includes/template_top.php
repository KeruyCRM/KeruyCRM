...
switch ($lang) {
    default:
        define(
            'TEXT_APP_TITLE',
            'KeruyCRM EXT | Автоматичне оновлення бази даних з ' . TEXT_UPDATE_VERSION_FROM . ' до ' . TEXT_UPDATE_VERSION_TO
        );
        define('TEXT_PROCESSING', 'Опрацювання...');
        define('TEXT_UPDATE_COMPLATED', 'Оновлення завершено');
        define('TEXT_UPDATE_ALREADY_RUN', 'Ви вже здійснили це оновлення');
        break;
}
