...
('43','CFG_APP_LANGUAGE','" . db_input($_GET['lng']) . ".php'),
('44','CFG_APP_SKIN',''),
('45','CFG_PUBLIC_USER_PROFILE_FIELDS','');
				
INSERT INTO app_entity_1 VALUES
('1',0,'0','0','0','" . time() . "','0',NULL,'0','" . $hasher->HashPassword(
        $_POST['user_password']
    ) . "','',1,'1','0','" . db_input($_POST['fields'][7]) . "','" . db_input($_POST['fields'][8]) . "','" . db_input(
        $_POST['fields'][9]
    ) . "','','" . db_input($_POST['fields'][12]) . "','" . db_input($_GET['lng']) . ".php','blue'," . time() . ");
";
