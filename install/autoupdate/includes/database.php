...
function db_connect($server, $username, $password, $database, $port, $link = 'db_link', $params = [])
{
    global $$link;
...
function db_query($query, $link = 'db_link')
{
    ...
    $result = mysqli_query($$link, $query) or die(
        '<div style="color: red">' . $query . '<br>' . mysqli_errno(
            $$link
        ) . '<br>' . mysqli_error($$link) . '</div>'
    );
...
function db_error($error, $params = [])
{
