...
<h3 class="page-title"><?php
    echo TEXT_RECORDS_VISIBILITY . ' <i class="fa fa-angle-right"></i> ' . $current_rules_info['id'] . ' <i class="fa fa-angle-right"></i> ' . TEXT_FILTERS ?></h3>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            echo button_tag(
                ...
                url_for(
                    'records_visibility/filters_form',
                    'rules_id=' . $current_rules_info['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param
                )
            ) ?>
                        ...
                        <tr>
                            <td style="white-space: nowrap;"><?php
                                echo button_icon_delete(
                                        url_for(
                                            'records_visibility/filters_delete',
                                            'rules_id=' . $current_rules_info['id'] . '&id=' . $v['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param
                                        )
                                    ) . ' ' . button_icon_edit(
                                        url_for(
                                            'records_visibility/filters_form',
