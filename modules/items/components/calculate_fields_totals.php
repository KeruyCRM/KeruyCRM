...
$totals_array = [];
$totals_query = db_query(
    "select " . implode(
        ', ',
        $sum_sql_query
    ) . " " . $listing_sql_query_select . " from app_entity_" . $current_entity_id . " e " . $listing_sql_query_join . " where e.id>0 " . str_replace(
        'having',
