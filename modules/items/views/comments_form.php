...
echo form_tag(
    'comments_form',
    url_for('items/comments', 'action=save' . (isset($_GET['id']) ? '&id=' . $_GET['id'] : '')),
...
<div class="modal-body">
    <div class="form-body">
        ...
        <?php
        $obj = (isset($_GET['id']) ? db_find('app_comments', $_GET['id']) : db_show_columns('app_comments')) ?>
...
//build default tab   
          ...
          <div class="form-group form-group-' . $v['id'] . '">
          	<label class="col-md-3 control-label" for="fields_' . $v['id'] . '">' . ($v['tooltip_display_as'] == 'icon' ? tooltip_icon(
                        $v['tooltip']
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    echo fields_types::render(
                        ...
                        ['id' => 'attachments'],
                        ['field_attachments' => $obj['attachments']]
                    ) ?>
                    <?php
