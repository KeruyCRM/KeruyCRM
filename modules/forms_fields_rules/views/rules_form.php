...
<div class="modal-body">
    <div class="form-body ajax-modal-width-790">
        ...
        $fields_query = db_query(
            "select f.*, t.name as tab_name from app_fields f, app_forms_tabs t where f.type in ('fieldtype_entity','fieldtype_entity_ajax','fieldtype_entity_multilevel','fieldtype_dropdown','fieldtype_dropdown_multiple','fieldtype_checkboxes','fieldtype_radioboxes','fieldtype_user_accessgroups','fieldtype_grouped_users','fieldtype_boolean_checkbox','fieldtype_boolean','fieldtype_autostatus','fieldtype_stages') and f.entities_id='" . _get::int(
                'entities_id'
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                ...
                echo select_tag(
                    ...
                    $choices,
                    $obj['fields_id'],
                    ['class' => 'form-control input-medium required ', 'onChange' => 'get_fields_choices()']
                ) ?>
                <?php
                echo tooltip_text(
                    TEXT_AVAILABLE_FIELDS . ': ' . TEXT_FIELDTYPE_DROPDOWN_TITLE . ', ' . TEXT_FIELDTYPE_RADIOBOXES_TITLE . ', ' . TEXT_FIELDTYPE_CHECKBOXES_TITLE
                ) ?>
            </div>
        </div>
...
<script>
    function get_fields_choices() {
        ...
        $('#fields_choices').load('<?php echo url_for(
            'forms_fields_rules/rules',
            'action=get_fields_choices&entities_id=' . $_GET['entities_id'] . '&id=' . $obj['id']
        )?>&fields_id=' + fields_id, function (response, status, xhr) {
