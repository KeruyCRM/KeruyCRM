...
<h3 class="page-title"><?php
    echo TEXT_HEADING_FILTERS_FOR_REPORT . ' ' . link_to(
            $page_title,
            url_for('reports/view', 'reports_id=' . $current_reports_info['id'])
        ) ?></h3>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            echo button_tag(
                ...
                url_for('reports/filters_form', 'reports_id=' . $current_reports_info['id'] . $parent_reports_param)
            ) ?>
...
<?php
echo '<a class="btn btn-default" href="' . url_for('reports/reports') . '">' . TEXT_BUTTON_BACK . '</a>'; ?>
