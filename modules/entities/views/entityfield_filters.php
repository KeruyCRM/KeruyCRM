...
require(component_path('entities/navigation')) ?>
    ...
    <h3 class="page-title"><?php
        echo TEXT_NAV_LISTING_FILTERS_CONFIG . ' (' . $fields_info['name'] . ')' ?></h3>
...
echo button_tag(
        ...
        url_for(
            'entities/entityfield_filters_form',
        ...
        url_for(
            'reports/sorting',
            'reports_id=' . $reports_info['id'] . '&redirect_to=entityfield_filters&fields_id=' . $_GET['fields_id']
        )
    ) ?>
                ...
                <tr>
                    <td style="white-space: nowrap;"><?php
                        echo button_icon_delete(
                                url_for(
                                    'entities/entityfield_filters_delete',
