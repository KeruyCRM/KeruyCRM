...
<h3 class="page-title"><?php
    echo TEXT_NAV_COMMENTS_ACCESS ?></h3>

<p><?php
    echo TEXT_COMMENTS_ACCESS_INFO ?></p>

<?php
echo form_tag('cfg', url_for('entities/comments_access', 'action=set_access&entities_id=' . $_GET['entities_id'])) ?>
...
<div class="table-scrollable">
    <table class="table table-striped table-bordered table-hover">
        ...
        $groups_query = db_query(
            "select ag.* from app_access_groups ag, app_entities_access ea where ea.access_groups_id=ag.id and ea.entities_id='" . db_input(
                $_GET['entities_id']
