...
<h3 class="page-title"><?php
    echo TEXT_NAV_USER_PUBLIC_PROFILE_CONFIG ?></h3>

<div><?php
    echo TEXT_USER_PUBLIC_PROFILE_CFG_INFO ?></div>
...
<table style="width: 100%; max-width: 960px;">
    <tr>
        <td valign="top" width="50%">
            <fieldset>
                <legend><?php
                    echo TEXT_FIELDS_IN_USER_PUBLIC_PROFILE ?></legend>
        ...
        <td style="padding-left: 25px;" valign="top">
            ...
            <fieldset>
                <legend><?php
                    echo TEXT_FIELDS_EXCLUDED_FROM_USER_PUBLIC_PROFILE ?></legend>
                <div class="cfg_listing">
