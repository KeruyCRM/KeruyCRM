...
echo form_tag(
    ...
    url_for(
        ...
        'action=save&redirect_to=' . $app_redirect_to . '&reports_id=' . $_GET['reports_id'] . (isset($_GET['parent_reports_id']) ? '&parent_reports_id=' . $_GET['parent_reports_id'] : '') . (isset($_GET['id']) ? '&id=' . $_GET['id'] : '')
    ),
