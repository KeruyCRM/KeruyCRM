<?php
echo ajax_modal_template_header(TEXT_DELETE_SELECTED) ?>

<?php
echo form_tag(
    'form-copy-to',
    url_for('global_lists/choices', 'action=multiple_delete&lists_id=' . $_GET['lists_id']),
...
<div class="modal-body">
    <div id="modal-body-content">
        ...
        <?php
        echo TEXT_DELETE_SELECTED_CONFIRMATION ?>
