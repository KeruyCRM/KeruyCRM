<?php
echo ajax_modal_template_header(TEXT_BUTTON_EDIT) ?>

<?php
echo form_tag(
    'form-copy-to',
    url_for('global_lists/choices', 'action=multiple_edit&lists_id=' . $_GET['lists_id']),
    ...
    <div id="modal-body-content">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                ...
                echo select_tag('parent_id', $choices, -1, ['class' => 'form-control input-large chosen-select'])
                ?>
                <?php
                echo tooltip_text(TEXT_CHOICES_PARENT_INFO); ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                ...
                echo '#ff0000' ?>">
                    <?php
                    echo input_tag('bg_color', '', ['class' => 'form-control input-small']) ?>
                    <span class="input-group-btn">
  				<button class="btn btn-default" type="button">&nbsp;</button>
  			</span>
                </div>
                <?php
                echo tooltip_text(TEXT_CHOICES_BACKGROUND_COLOR_INFO); ?>
            </div>
        </div>
