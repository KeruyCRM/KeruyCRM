...
echo form_tag(
    'users_groups_form',
    url_for('users_groups/users_groups', 'action=save' . (isset($_GET['id']) ? '&id=' . $_GET['id'] : '')),
...
<div class="modal-body">
    <div class="form-body">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a href="#ldap_tab" data-toggle="tab"><?php
                    echo TEXT_HEADING_LDAP ?></a></li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="ldap_tab">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label" for="is_ldap_default"><?php
                        echo TEXT_IS_LDAP_DEFAULT ?></label>
                    <div class="col-md-9">
                        <div class="checkbox-list"><label class="checkbox-inline"><?php
                                echo input_checkbox_tag('is_ldap_default', '1', ['checked' => $obj['is_ldap_default']]
                                ) ?></label></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label" for="name"><?php
                        echo TEXT_LDAP_GROUP_FILTER ?></label>
                    <div class="col-md-9">
                        <?php
                        echo input_tag('ldap_filter', $obj['ldap_filter'], ['class' => 'form-control input-medium']) ?>
                        <?php
                        echo tooltip_text(TEXT_LDAP_GROUP_FILTER_INFO) ?>
                    </div>
                </div>
