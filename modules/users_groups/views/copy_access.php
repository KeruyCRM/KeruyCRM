<?php
echo ajax_modal_template_header(TEXT_COPY_ACCESS) ?>

<?php
echo form_tag(
    'form-copy-to',
    url_for('users_groups/copy_access', 'action=copy_selected&id=' . $users_groups_info['id']),
...
<div class="modal-body">
    <div id="modal-body-content">
        ...
        $groups_query = db_query(
            "select * from app_access_groups where id!='" . $users_groups_info['id'] . "' order by sort_order, name"
        );
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php
                echo select_tag('copy_to_group_id', $choices, '', ['class' => 'form-control required']) ?>
                <?php
                echo tooltip_text(TEXT_COPY_ACCESS_INFO) ?>
            </div>
        </div>
