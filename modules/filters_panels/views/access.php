...
echo form_tag(
    'menu_form',
    url_for('filters_panels/panels', 'action=set_default_panel_access&entities_id=' . $_GET['entities_id']),
...
<div class="modal-body">
    <div class="form-body">
        ...
        <p><?php
            echo TEXT_FILTERS_PANELS_ACCESS_INFO ?></p>
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                echo select_tag(
                    'users_groups[]',
                    $choices,
                    $entities_cfg->get('default_filter_panel_access'),
