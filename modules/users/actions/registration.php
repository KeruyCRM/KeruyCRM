...
$current_entity_id = 1;
$current_path_array = [1];
$app_user = [];
$app_user['group_id'] = (count(
    explode(',', CFG_PUBLIC_REGISTRATION_USER_GROUP)
) == 1 ? CFG_PUBLIC_REGISTRATION_USER_GROUP : 0);
$app_user['id'] = 0;
    ...
    case 'save':
        ...
        if (!$is_error) {
            ...
            $fields_query = db_query(
                ...
                ) . ",'fieldtype_related_records','fieldtype_user_last_login_date') and  f.entities_id='" . db_input(
                    $current_entity_id
