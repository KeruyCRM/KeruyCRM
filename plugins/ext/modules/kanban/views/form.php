...
echo form_tag(
    'configuration_form',
    url_for('ext/kanban/reports', 'action=save' . (isset($_GET['id']) ? '&id=' . $_GET['id'] : '')),
    ...
    <div class="form-body">
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="general_info">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label" for="name"><?php
                        echo TEXT_EXT_COLUMN_WIDTH ?></label>
                    <div class="col-md-9">
                        <?php
                        echo input_tag('width', $obj['width'], ['class' => 'form-control input-medium ']) ?>
                    </div>
                </div>
