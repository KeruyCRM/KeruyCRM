...
<div class="modal-body">
    <div class="form-body">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_value" data-toggle="tab"><?php
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="tab_value">
                    ...
                    <div class="col-md-9"><?php
                        echo select_tag(
                            ...
                            [
                                ...
                                'multiple' => 'multiple',
                                'chosen_order' => (is_array($settings->get('fields')) ? implode(
                                    ',',
                                    $settings->get('fields')
                                ) : '')
                            ]
                ...
                <div class="form-group settings-list" form_display_rules="settings_display_field_names:1">
                    <label class="col-md-3 control-label" for="fields_id"><?php
                        echo TEXT_EXT_COLUMN_WIDTH . ' (' . TEXT_VALUE . ')' ?></label>
                    <div class="col-md-9"><?php
                        echo input_tag(
                            'settings[value_column_width]',
                            $settings->get('value_column_width', ''),
                ...
                <div class="form-group" id="is-heading-container">
                    ...
                    <div class="col-md-9">
                        <div class="checkbox-list"><label class="checkbox-inline"><?php
                                echo select_tag(
                                    'settings[display_field_names]',
                                    ['1' => TEXT_YES, '0' => TEXT_NO],
                                    $settings->get('display_field_names', 1),
                ...
                <div class="form-group settings-list" form_display_rules="settings_display_field_names:1">
                    <label class="col-md-3 control-label" for="fields_id"><?php
                        echo TEXT_EXT_COLUMN_WIDTH . ' (' . TEXT_TITLE . ')' ?></label>
                    <div class="col-md-9"><?php
                        echo input_tag(
                            'settings[field_name_column_width]',
                            $settings->get('field_name_column_width', ''),
                            ['class' => 'form-control input-small number']
                        ) ?></div>
                </div>
                ...
                <div class="form-group settings-table">
                    <label class="col-md-3 control-label" for="fields_id"><?php
                        echo TEXT_EXT_BORDER ?></label>
                    <div class="col-md-2"><?php
                        echo select_tag(
                            'settings[border]',
                            ['' => '', 'table' => TEXT_TABLE, 'row' => TEXT_ROW],
                            $settings->get('border'),
                            ['class' => 'form-control input-small ']
                        ) ?></div>
                    <div class="col-md-3"><?php
                        echo input_color('settings[border_color]', $settings->get('border_color')) ?></div>
                </div>
                <div class="form-group settings-table">
                    <label class="col-md-3 control-label" for="fields_id"><?php
                        echo TEXT_EXT_CELL_MARGIN ?></label>
                    <div class="col-md-9"><?php
                        echo input_tag(
                            'settings[cell_margin]',
                            $settings->get('cell_margin', '0'),
