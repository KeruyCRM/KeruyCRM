...
echo button_tag(
    TEXT_BUTTON_ADD,
    url_for(
        'ext/templates_docx/table_blocks_form',
...
<div class="table-scrollable">
    <table class="table table-striped table-bordered table-hover">
        ...
        $blocks_query = db_query(
            "select b.*, f.name, f.entities_id, f.type as field_type,f.configuration as field_configuration from app_ext_items_export_templates_blocks b, app_fields f, app_entities e where  block_type='body_cell' and b.fields_id=f.id and b.templates_id = " . $template_info['id'] . " and b.parent_id = " . $parent_block['id'] . " and f.entities_id=e.id order by b.sort_order, b.id",
            false
        );
            ...
            <tr>
                <td style="white-space: nowrap;"><?php
                    echo button_icon_delete(
                            url_for(
                                'ext/templates_docx/table_blocks_delete',
...
<?php
require(component_path('ext/templates_docx/table_preview')) ?>