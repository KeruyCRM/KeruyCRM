    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            echo button_tag(
                ...
                url_for(
                    'ext/common_filters/filters_form',
                        ...
                        <tr>
                            <td style="white-space: nowrap;"><?php
                                echo button_icon_delete(
                                        url_for(
                                            'ext/common_filters/filters_delete',
...
<?php
echo '<a class="btn btn-default" href="' . url_for('ext/common_filters/reports') . '">' . TEXT_BUTTON_BACK . '</a>'; ?>
