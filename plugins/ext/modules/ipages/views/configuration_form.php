...
<div class="modal-body">
    <div class="form-body">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a href="#code" data-toggle="tab"><?php
                    echo TEXT_EXT_CODE ?></a></li>
        </ul>
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="general_info">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label" for="short_name"><?php
                        echo TEXT_SHORT_NAME ?></label>
                    <div class="col-md-9">
                        <?php
                        echo input_tag('short_name', $obj['short_name'], ['class' => 'form-control input-large']) ?>
                        <?php
                        echo tooltip_text(TEXT_EXT_IPAGE_SHORT_NAME_TOOLTIP) ?>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="code">
                ...
                <p><?php
                    echo TEXT_EXT_IPAGES_CODE_INFO ?></p>
                <div class="form-group">
                    <label class="col-md-3 control-label" for="allowed_groups"><?php
                        echo 'HTML/JavaScript' ?></label>
                    <div class="col-md-9">
                        <?php
                        echo textarea_tag('html_code', $obj['html_code'], ['class' => 'form-control']) ?>
                    </div>
                </div>
