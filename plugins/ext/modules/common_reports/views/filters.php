...
<h3 class="page-title"><?php
    echo TEXT_HEADING_FILTERS_FOR_REPORT . ' ' . link_to($page_title, url_for('ext/common_reports/reports')) ?></h3>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            echo button_tag(
                ...
                url_for(
                    'ext/common_reports/filters_form',
                    'reports_id=' . $current_reports_info['id'] . $parent_reports_param
                )
            ) ?>
                        ...
                        <tr>
                            <td style="white-space: nowrap;"><?php
                                echo button_icon_delete(
                                        url_for(
                                            'ext/common_reports/filters_delete',
                                            'id=' . $v['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param
                                        )
                                    ) . ' ' . button_icon_edit(
                                        url_for(
                                            'ext/common_reports/filters_form',
...
<?php
echo '<a class="btn btn-default" href="' . url_for('ext/common_reports/reports') . '">' . TEXT_BUTTON_BACK . '</a>'; ?>
