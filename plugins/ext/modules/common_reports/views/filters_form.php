...
echo form_tag(
    'reports_filters',
    url_for(
        'ext/common_reports/filters',
        'action=save&reports_id=' . $_GET['reports_id'] . (isset($_GET['parent_reports_id']) ? '&parent_reports_id=' . $_GET['parent_reports_id'] : '') . (isset($_GET['id']) ? '&id=' . $_GET['id'] : '')
    ),
