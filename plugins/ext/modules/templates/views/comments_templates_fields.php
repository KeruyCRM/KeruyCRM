...
<ul class="page-breadcrumb breadcrumb">
    <li><?php
        echo link_to(TEXT_EXT_COMMENTS_TEMPLATES, url_for('ext/templates/comments_templates')) ?><i
...
echo button_tag(
    ...
    url_for('ext/templates/comments_templates_fields_form', 'templates_id=' . $template_info['id']),
    true
) ?>
...
<div class="table-scrollable">
    <table class="table table-striped table-bordered table-hover">
        ...
        $templates_fields_query = db_query(
            "select tf.id, tf.fields_id, tf.value, f.name from app_ext_comments_templates_fields tf, app_fields f left join app_forms_tabs t on f.forms_tabs_id=t.id  where f.id=tf.fields_id and tf.templates_id='" . db_input(
                $template_info['id']
            ...
            <tr>
                <td style="white-space: nowrap;"><?php
                    echo button_icon_delete(
                            url_for(
                                'ext/templates/comments_templates_fields_delete_confirm',
                                'id=' . $templates_fields['id']
                            )
                        ) . ' ' . button_icon_edit(
                            url_for(
                                'ext/templates/comments_templates_fields_form',
