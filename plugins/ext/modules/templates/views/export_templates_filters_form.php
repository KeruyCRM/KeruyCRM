...
echo form_tag(
    'reports_filters',
    url_for(
        'ext/templates/export_templates_filters',
        'action=save&templates_id=' . $_GET['templates_id'] . '&reports_id=' . $_GET['reports_id'] . (isset($_GET['parent_reports_id']) ? '&parent_reports_id=' . $_GET['parent_reports_id'] : '') . (isset($_GET['id']) ? '&id=' . $_GET['id'] : '')
    ),
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                ...
                echo select_tag(
                    'fields_id',
                    fields::get_filters_choices($reports_info['entities_id'], false, "'fieldtype_formula'"),
                    $obj['fields_id'],
                    ['class' => 'form-control required', 'onChange' => 'load_fitlers_options(this.value)']
                ) ?>
            </div>
        </div>
