...
<?php
echo form_tag('templates_filter', url_for('ext/templates/comments_templates')) ?>
...
<div class="modal-body">
    ...
    <ul id="templates" class="sortable">
        ...
        $templates_query = db_query(
            "select ep.*, e.name as entities_name from app_ext_comments_templates ep, app_entities e where e.id=ep.entities_id  and ep.entities_id='" . db_input(
    ...
    $(function () {
        $("ul.sortable").sortable({
            ...
            update: function (event, ui) {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo url_for("ext/templates/comments_templates", "action=sort_templates")?>',
                    data: data
                });
            }
        });
