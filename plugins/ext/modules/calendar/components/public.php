    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#calendar').fullCalendar({
                ...
                ) ? CFG_PUBLIC_CALENDAR_TIME_SLOT_DURATION : '00:30:00') ?>',
                customButtons: {
                    printButton: {
                        text: '',
                        icon: 'fa fa-print',
                ...
                header: {
                    ...
                    right: '<?php echo calendar::get_view_modes(
                        [
                            'view_modes' => CFG_PUBLIC_CALENDAR_VIEW_MODES,
                            'default_view' => CFG_PUBLIC_CALENDAR_DEFAULT_VIEW
                        ]
                    ) ?>'
                },
                ...
                eventResize: function (event, delta, revertFunc) {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo url_for('ext/calendar/public', 'action=resize') ?>",
                ...
                eventDrop: function (event, delta, revertFunc) {
                    if (event.end) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo url_for('ext/calendar/public', 'action=drop') ?>",
