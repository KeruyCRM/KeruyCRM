<h3 class="page-title"><?php
    echo TEXT_EXT_COMMON_REPORTS_GROUPS ?></h3>

<p><?php
    echo TEXT_REPORTS_GROUPS_INFO ?></p>

<?php
echo button_tag(TEXT_BUTTON_ADD, url_for('ext/reports_groups/form')) ?>
            ...
            <tr>
                <td style="white-space: nowrap;"><?php
                    echo button_icon_delete(
                            url_for('ext/reports_groups/delete', 'id=' . $v['id'])
                        ) . ' ' . button_icon_edit(url_for('ext/reports_groups/form', 'id=' . $v['id'])); ?></td>
                <td><?php
                    echo link_to_modalbox(
                        $v['name'],
                        url_for(
                            'dashboard/reports_groups_configure',
                            'id=' . $v['id'] . '&redirect_to=ext/reports_groups/reports'
                        )
                    ) ?></td>
                <td>
                    <?php
