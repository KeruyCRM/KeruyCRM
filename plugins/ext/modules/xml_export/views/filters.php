    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            echo button_tag(
                ...
                url_for(
                    'ext/xml_export/filters_form',
                    'templates_id=' . $current_templates_info['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param
                )
            ) ?>
                        ...
                        <tr>
                            <td style="white-space: nowrap;"><?php
                                echo button_icon_delete(
                                        url_for(
                                            'ext/xml_export/filters_delete',
                                            'templates_id=' . $current_templates_info['id'] . '&id=' . $v['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param
                                        )
                                    ) . ' ' . button_icon_edit(
                                        url_for(
                                            'ext/xml_export/filters_form',
...
<?php
echo '<a href="' . url_for('ext/xml_export/templates') . '" class="btn btn-default">' . TEXT_BUTTON_BACK . '</a>' ?>
