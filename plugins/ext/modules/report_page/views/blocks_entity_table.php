<ul class="page-breadcrumb breadcrumb">
    ...
    <li><?php
        echo $block_name ?><i class="fa fa-angle-right"></i></li>
    <li><?php
        echo TEXT_TABLE ?></li>
</ul>
...
echo button_tag(
    TEXT_BUTTON_ADD,
    url_for(
        'ext/report_page/blocks_entity_table_form',
...
<div class="table-scrollable">
    <table class="table table-striped table-bordered table-hover">
        ...
        $blocks_query = db_query(
            "select b.*,f.type as field_type, f.name as field_name, f.entities_id as field_entity_id from app_ext_report_page_blocks b left join app_fields f on b.field_id=f.id  where block_type='body_cell' and b.report_id={$report_page['id']} and b.parent_id = " . $block_info['id'] . " order by b.sort_order, b.id"
        );
            ...
            <tr>
                <td style="white-space: nowrap;"><?php
                    echo button_icon_delete(
                            url_for(
                                'ext/report_page/blocks_entity_table_delete',
                                'id=' . $blocks['id'] . '&report_id=' . $report_page['id'] . '&block_id=' . $block_info['id']
                            )
                        ) . ' ' . button_icon_edit(
                            url_for(
                                'ext/report_page/blocks_entity_table_form',
                ...
                <td><?php
                    echo $blocks['id'] ?></td>
                <td><?php
                    echo $app_entities_cache[$blocks['field_entity_id']]['name'] ?></td>
                <td><?php
