...
<h3 class="page-title"><?php
    echo TEXT_EXT_HEADING_FILTERS_FOR_FUNCTION . ' ' . link_to(
            $current_functions_info['name'],
            url_for('ext/functions/')
        ) ?></h3>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            echo button_tag(
                ...
                url_for(
                    'ext/functions/filters_form',
                    'functions_id=' . $current_functions_info['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param
                )
            ) ?>
                        ...
                        <tr>
                            <td style="white-space: nowrap;"><?php
                                echo button_icon_delete(
                                        url_for(
                                            'ext/functions/filters_delete',
                                            'functions_id=' . $current_functions_info['id'] . '&id=' . $v['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param
                                        )
                                    ) . ' ' . button_icon_edit(
                                        url_for(
                                            'ext/functions/filters_form',
...
<?php
echo '<a href="' . url_for('ext/functions/') . '" class="btn btn-default">' . TEXT_BUTTON_BACK . '</a>' ?>
