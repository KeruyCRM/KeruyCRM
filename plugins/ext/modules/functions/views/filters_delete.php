...
echo form_tag(
    ...
    url_for(
        ...
        'action=delete&functions_id=' . $_GET['functions_id'] . '&id=' . $_GET['id'] . '&reports_id=' . $_GET['reports_id'] . (isset($_GET['parent_reports_id']) ? '&parent_reports_id=' . $_GET['parent_reports_id'] : '')
    )
) ?>
<?php
