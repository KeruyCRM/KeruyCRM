...
$current_functions_info_query = db_query(
    "select * from app_ext_functions where id='" . db_input($_GET['functions_id']) . "'"
);
...
$current_reports_info_query = db_query(
    "select * from app_reports where id='" . db_input($current_functions_info['reports_id']) . "'"
);
