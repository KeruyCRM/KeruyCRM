...
$breadcrumb[] = '<li>' . link_to(
        $entity_info['name'],
        url_for('ext/pivot_calendars/entities', 'calendars_id=' . $pivot_calendar_info['id'])
    ) . '<i class="fa fa-angle-right"></i></li>';
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            echo button_tag(
                ...
                url_for(
                    'ext/pivot_calendars/filters_form',
                    'calendars_id=' . $pivot_calendar_info['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param
                )
            ) ?>
                        ...
                        <tr>
                            <td style="white-space: nowrap;"><?php
                                echo button_icon_delete(
                                        url_for(
                                            'ext/pivot_calendars/filters_delete',
                                            'calendars_id=' . $pivot_calendar_info['id'] . '&id=' . $v['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param
                                        )
                                    ) . ' ' . button_icon_edit(
                                        url_for(
                                            'ext/pivot_calendars/filters_form',
