...
class Paper
{
    ...
    */
    public function archive($doc_id)
    {
        ...
        $postdata = json_encode(["doc_id" => $doc_id]);
    ...
    */
    public function download($doc_id, $export_format)
    {
        ...
        $postdata = json_encode(["doc_id" => $doc_id, "export_format" => $export_format]);
        $returnData = Dropbox::postRequest($endpoint, $headers, $postdata);
        if (isset($returnData["error"])) {
            return $returnData["error_summary"];
        } else {
    ...
    */
    public function folder_users_list($doc_id, $limit = 1000)
    {
        ...
        $postdata = json_encode(["doc_id" => $doc_id, "limit" => $limit]);
        $returnData = Dropbox::postRequest($endpoint, $headers, $postdata);
        if (isset($returnData["error"])) {
            return $returnData["error_summary"];
        } else {
    ...
    */
    public function folder_users_list_continue($doc_id, $cursor)
    {
        ...
        $postdata = json_encode(["doc_id" => $doc_id, "cursor" => $cursor]);
        $returnData = Dropbox::postRequest($endpoint, $headers, $postdata);
        if (isset($returnData["error"])) {
            return $returnData["error_summary"];
        } else {
    ...
    */
    public function list_all_paper(
        ...
        $postdata = json_encode(
            ["filter_by" => $filter_by, "sort_by" => $sort_by, "sort_order" => $sort_order, "limit" => $limit]
        );
    ...
    */
    public function users_add($doc_id, $members, $quiet = false, $custom_message = null)
    {
        ...
        $postdata = json_encode(["doc_id" => $doc_id, "members" => $members, "quiet" => $quiet]);
    ...
    */
    public function users_list($doc_id, $limit = 1000, $filter_by = "shared")
    {
        ...
        $postdata = json_encode(["doc_id" => $doc_id, "limit" => $limit, "filter_by" => $filter_by]);
        $returnData = Dropbox::postRequest($endpoint, $headers, $postdata);
        if (isset($returnData["error"])) {
            return $returnData["error_summary"];
        } else {
    ...
    */
    public function users_remove($doc_id, $member)
    {
        ...
        $postdata = json_encode(["doc_id" => $doc_id, "member" => $member]);
        $returnData = Dropbox::postRequest($endpoint, $headers, $postdata);
        if (isset($returnData["error"])) {
            return $returnData["error_summary"];
        } else {
