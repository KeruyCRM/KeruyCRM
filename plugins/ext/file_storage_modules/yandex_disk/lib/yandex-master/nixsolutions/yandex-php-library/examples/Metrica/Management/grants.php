        ...
        if ($errorMessage === 'PlatformNotAllowed') {
            $errorMessage .= '<p>Возможно, у приложения нет прав на доступ к ресурсу. Попробуйте '
                . '<a href="' . rtrim(
                    ...
                    "/"
                ) . '/../OAuth/' . '">авторизироваться</a> и повторить.</p>';
        }
    }
}
?>
...
<div class="container">
    <div class="jumbotron">
        <h2><a href="/examples/Metrica"><span class="glyphicon glyphicon-tasks"></span></a> Пример работы с Яндекс
            Метрикой</h2>
    </div>
    <ol class="breadcrumb">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="addGrantUserLogin"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="addGrantCreateAt"
                                   placeholder="Дата предоставления доступа">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="updateGrantUserLogin"
                                   placeholder="Логин пользователя">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="updateGrantCreateAt" class="col-sm-2 control-label">Дата предоставления
                            доступа</label>

                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="updateGrantCreateAt"
                                   placeholder="Дата предоставления доступа">
                        </div>
                    </div>
                    <div class="form-group">
