            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="format" name="format">
                        <option <?php
                        if (isset($_POST['format']) && $_POST['format'] === SpellerClient::CHECK_TEXT_FORMAT_PLAIN) { ?> selected <?php
                        } ?> ><?= SpellerClient::CHECK_TEXT_FORMAT_PLAIN ?></option>
                        <option <?php
                        if (isset($_POST['format']) && $_POST['format'] === SpellerClient::CHECK_TEXT_FORMAT_HTML) { ?> selected <?php
                        } ?>><?= SpellerClient::CHECK_TEXT_FORMAT_HTML ?></option>
                    </select>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="ie" name="ie">
                        <option <?php
                        if (isset($_POST['ie']) && $_POST['ie'] === 'utf-8') { ?> selected <?php
                        } ?> >utf-8
                        </option>
                        <option <?php
                        if (isset($_POST['ie']) && $_POST['ie'] === '1251') { ?> selected <?php
                        } ?>>1251
                        </option>
                    </select>
                </div>
