...
class CategoryClient extends ContentClient
{
     ...
     */
    public function get($categoryId, $params = [])
    {
     ...
     * @return Models\ResponseCategoryGetList
     */
    public function getChildren($categoryId, $params = [])
    {
     ...
     */
    public function getModels($categoryId, $params = [])
    {
     ...
     */
    public function getFilters($categoryId, $params = [])
    {
