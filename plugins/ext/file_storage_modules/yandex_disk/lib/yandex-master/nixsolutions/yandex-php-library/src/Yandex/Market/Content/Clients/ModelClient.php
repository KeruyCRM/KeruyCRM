...
class ModelClient extends ContentClient
{
     ...
     */
    public function get($modelId, $params = [])
    {
     ...
     */
    public function getInfo($modelId, $params = [])
    {
     ...
     */
    public function getOffers($modelId, $params = [])
    {
     ...
     */
    public function getOutlets($modelId, $params = [])
    {
     ...
     */
    public function getOpinions($modelId, $params = [])
    {
