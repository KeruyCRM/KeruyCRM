...
<div class="container">
    ...
    if (!isset($_COOKIE['yaAccessToken']) || !isset($_COOKIE['yaClientId'])) {
        ...
        <div class="alert alert-info">
            ...
            <a id="goToAuth"
               href="<?php
               echo rtrim(str_replace($_SERVER['DOCUMENT_ROOT'], '', __DIR__), "/") . '/../OAuth/' ?>"
        ...
        <div>
            ...
            <?php
            foreach ($collections as $collectionName => $records) { ?>
                <div class="col-sm-2"><h3><?php
                        echo $collectionName;//Идентификатор Коллекции ?></h3></div>
                <div class="col-sm-10">
                    <?php
                    foreach ($records as $recordName => $fields) { ?>
                        <h4><?php
                            echo $recordName;//Идентификатор Записи ?></h4>
                        <table id="accountTable" class="table table-striped table-bordered table-hover">
                            ...
                            foreach ($fields as $fieldName => $value) { ?>
                                <tr>
                                    <td><?php
                                        echo $fieldName;//Идентификатор Поля ?></td>
                                    <td><?php
                                        echo $value;//Значение Поля ?></td>
                                </tr>
                    ...
                    <div class="modal-content">
                        <form class="form-horizontal" action="database.php?databaseId=<?= $database->getDatabaseId() ?>"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="inputRecordId" class="col-sm-4 control-label">Идентификатор
                                        записи</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="recordChangeType" id="inputRecordChangeType">
                                            ...
                                            <option value="update">update - Частичное изменение записи (изменяются
                                                только
