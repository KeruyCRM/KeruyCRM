...
class Worksheet implements IComparable
{
    ...
    public function setCodeName($pValue, $validate = true)
    {
        ...
        if ($validate) {
            $pValue = str_replace(' ', 'K', $pValue); //Excel does this automatically without flinching, we are doing the same
            ...
            if ($this->getParent()) {
                ...
                if ($this->getParent()->sheetCodeNameExists($pValue)) {
                    ...
                    $i = 1;
                    while ($this->getParent()->sheetCodeNameExists($pValue . 'K' . $i)) {
                        ++$i;
                        if ($i == 10) {
                    ...
                    $pValue .= 'K' . $i; // ok, we have a valid name
                }
            }
        }
