...
class Forms_tabs_delete extends \Controller
{
    ...
    public function index()
    {
        ...
        if (strlen($msg) > 0) {
            ...
            \K::$fw->content = sprintf(
                ...
                \Models\Main\Forms_tabs::get_name_by_id(\K::$fw->GET['id'])
            );
            \K::$fw->button_title = \K::$fw->TEXT_BUTTON_DELETE;
        }

        \K::$fw->subTemplate = \K::$fw->pathSubTemplate . 'forms_tabs_delete.php';
