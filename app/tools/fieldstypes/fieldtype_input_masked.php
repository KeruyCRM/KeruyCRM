...
class Fieldtype_input_masked
{
    ...
    {
        $this->options = ['title' => \K::f3()->TEXT_FIELDTYPE_INPUT_MASKED];
    }
    ...
    public function get_configuration()
    {
        ...
        $cfg[] = [
            ...
            'name' => 'mask',
            'type' => 'input',
            'tooltip' => \K::f3()->TEXT_INPUT_FIELD_MASK_TIP,
            'params' => ['class' => 'form-control']
        ];

        $cfg[] = [
            'title' => \K::f3()->TEXT_INPUT_FIELD_MASK_DEFINITIONS,
            'name' => 'mask_definitions',
            'type' => 'textarea',
            'tooltip_icon' => \K::f3()->TEXT_INPUT_FIELD_MASK_DEFINITIONS_TIP_ICON,
            'tooltip' => \K::f3()->TEXT_INPUT_FIELD_MASK_DEFINITIONS_TIP,
            'params' => ['class' => 'form-control']
        ];
