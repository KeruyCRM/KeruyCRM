...
class Fieldtype_attachments
{
    ...
    public static function get_accept_types($cfg)
    {
        $params = [];
    ...
    public static function get_accept_types_by_file($allowed_extensions = '')
    {
        $params = [];
    ...
    public static function get_accept_types_by_extensions($allowed_extensions)
    {
        if (strlen($allowed_extensions)) {
            $extensions = [];
            foreach (explode(',', $allowed_extensions) as $v) {
