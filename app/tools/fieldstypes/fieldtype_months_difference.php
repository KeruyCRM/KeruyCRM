...
class Fieldtype_months_difference
{
    ...
    {
        $this->options = ['title' => \K::f3()->TEXT_FIELDTYPE_MONTHS_DIFFERENCE_TITLE];
    }
    ...
    public function get_configuration()
    {
        ...
        $cfg[] = [
            'title' => \K::f3()->TEXT_CALCULATE_DIFFERENCE_DAYS,
            'tooltip_icon' => \K::f3()->TEXT_CALCULATE_DIFFERENCE_DAYS_INFO,
    ...
    {
        $sql = "
CREATE FUNCTION `keruycrm_months_diff`(`start_date` INT, `end_date` INT, `inc_days` TINYINT(1)) RETURNS int(11)
BEGIN  				
