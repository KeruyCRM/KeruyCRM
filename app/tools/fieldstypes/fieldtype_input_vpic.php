...
class Fieldtype_input_vpic
{
    ...
    {
        $this->options = ['title' => \K::f3()->TEXT_FIELDTYPE_INPUT_VPIC_TITLE];
    }
    ...
    public function get_configuration()
    {
        ...
        $cfg[] = [
            'title' => \K::f3()->TEXT_VPIC_AUTO_FILL_FIELDS,
            'name' => 'auto_fill_fields',
            'type' => 'checkbox',
            'tooltip_icon' => \K::f3()->TEXT_VPIC_AUTO_FILL_FIELDS_TIP
        ];

        $cfg[] = [
            'title' => \K::f3()->TEXT_VPIC_OTHER_DETAILS,
            'name' => 'other_details',
            'type' => 'input',
            'tooltip_icon' => \K::f3()->TEXT_VPIC_OTHER_DETAILS_TIP,
