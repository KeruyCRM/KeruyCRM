...
class Fieldtype_digital_signature
{
    ...
    public static function check_button_filter($options)
    {
    ...
    public static function has_sign_access($entities_id, $items_id, $fields_id)
    {
        global $app_user;
    ...
    public static function reset_signature_if_data_changed($entities_id, $items_id, $previous_item_info)
    {
