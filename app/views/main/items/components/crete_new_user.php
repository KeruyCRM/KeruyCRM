...
$body = str_replace(['[FirstName]', '[LastName]'],
    [db_prepare_input($_POST['fields'][7]), db_prepare_input($_POST['fields'][8])],
...
$options = [
    ...
    'body' => $body . '<p><b>' . TEXT_LOGIN_DETAILS . '</b></p><p>' . TEXT_USERNAME . ': ' . $_POST['fields'][12] . '<br>' . TEXT_PASSWORD . ': ' . $password . '</p><p><a href="' . url_for(
            'users/login',
            '',
            true
