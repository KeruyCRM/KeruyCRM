...
<fieldset>
    <legend><?php
        echo TEXT_NAV_LISTING_FILTERS_CONFIG ?></legend>
    <p><?php
    ...
    echo button_tag(
        ...
        url_for(
            ...
            'fields_id=' . $fields_info['id'] . '&entities_id=' . $_GET['entities_id']
        ),
        false
    ) ?>
    <br><br>
        ...
        <fieldset>
            ...
            <div class="checkbox-list">
                ...
                $fields_query = db_query(
                    "select f.*, t.name as tab_name from app_fields f, app_forms_tabs t where (is_heading = 0 or is_heading is null) and f.type not in ('fieldtype_action','fieldtype_parent_item_id') and  f.entities_id='" . db_input(
                        $cfg['entity_id']
