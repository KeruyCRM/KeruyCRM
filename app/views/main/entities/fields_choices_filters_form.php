...
<?= \Helpers\Html::form_tag(
    ...
    \Helpers\Urls::url_for(
        'main/entities/fields_choices_filters/save',
        'choices_id=' . \K::$fw->GET['choices_id'] . (isset(\K::$fw->GET['id']) ? '&id=' . \K::$fw->GET['id'] : '') . '&entities_id=' . \K::$fw->GET['entities_id'] . '&fields_id=' . \K::$fw->GET['fields_id']
    ),
