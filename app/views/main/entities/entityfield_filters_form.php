...
<?= \Helpers\Html::form_tag(
    ...
    \Helpers\Urls::url_for(
        'main/entities/entityfield_filters/save',
        'reports_id=' . \K::$fw->GET['reports_id'] . (isset(\K::$fw->GET['id']) ? '&id=' . \K::$fw->GET['id'] : '') . '&entities_id=' . \K::$fw->GET['entities_id'] . '&fields_id=' . \K::$fw->GET['fields_id']
    ),
