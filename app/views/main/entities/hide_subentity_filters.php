...
require(component_path('entities/navigation')) ?>
    ...
    <h3 class="page-title"><?php
        echo TEXT_HIDE_BY_CONDITION . ' (' . TEXT_ITEM_PAGE_PARENT_ITEM . ')' ?></h3>

    <p><?php
        echo TEXT_HIDE_BY_CONDITION_SUBENTITY_INFO ?></p>

<?php
echo button_tag(
    TEXT_BUTTON_ADD_NEW_REPORT_FILTER,
    url_for(
        'entities/hide_subentity_filters_form',
                ...
                <tr>
                    <td style="white-space: nowrap;"><?php
                        echo button_icon_delete(
                                url_for(
                                    'entities/hide_subentity_filters_delete',
