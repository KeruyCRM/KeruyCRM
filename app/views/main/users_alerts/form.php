...
echo form_tag(
    'users_alerts_form',
    url_for('users_alerts/users_alerts', 'action=save' . (isset($_GET['id']) ? '&id=' . $_GET['id'] : '')),
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                ...
                echo select_tag(
                    'type',
                    users_alerts::get_types_choices(),
                    $obj['type'],
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <?php
                echo input_tag('title', $obj['title'], ['class' => 'form-control input-xlarge required']) ?>
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-md-3 control-label" for="location"><?php
                echo TEXT_LOCATION ?></label>
            <div class="col-md-9">
                <?php
                echo select_tag(
                    'location',
                    users_alerts::get_location_choices(),
                    $obj['location'],
                    ['class' => 'form-control input-medium']
                ) ?>
            </div>
