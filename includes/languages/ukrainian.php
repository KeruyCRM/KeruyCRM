...
define('TEXT_ERROR_USEREMAL_EXIST', 'E-mail вже існує!');
define('TEXT_ERROR_USERNAME_EXIST', 'Ім`я користувача вже існує!');
define('TEXT_ERROR_USEREMAL_EMPTY', 'E-mail користувача не може бути порожнім.');
...
define('TEXT_ERROR_PASSOWRD_CONFIRMATION', 'Підтвердження паролю має співпадати з вашим паролем.');
define('TEXT_ERROR_PASSOWRD_LENGTH', 'Ваш пароль повинен містити не менше ' . CFG_PASSWORD_MIN_LENGTH . ' символів.');
...
define('TEXT_HEADING_ENTITY_IFNO', 'Інформація про сутність');
...
define('TEXT_COMMENT_IFNO', 'Коментар');
...
define('TEXT_AVAILABLE_FIELS', 'Доступні поля');
define('TEXT_FIELDS_IN_COMMENTS_FORM', 'Поля в формі коментарів');
define('TEXT_HEADING_FIELD_IFNO', 'Iнформацiя про поле');
...
define('TEXT_INPTUT_SMALL', 'Невелике поле ');
...
define('TEXT_HEADING_VALUE_IFNO', 'Деталі');
...
define('TEXT_HEADING_USER_GROUP_IFNO', 'Інформація про групу');
...
define('TEXT_FILE_NOT_FOUD', 'Файл не знайдено');
define(
...
define('TEXT_HEADING_REPORTS_IFNO', 'Інформація про звіт');
define('TEXT_WARN_DELETE_REPORT_SUCCESS', 'Звіт видалено');
define('TEXT_REPORT_ENTITY', 'Сутність');
define('TEXT_VIEW', 'Переглянути');
define('TEXT_PLEASE_WAYIT_FILES_LOADING', 'Будь ласка, зачекайте, файли завантажуються.');
...
define('TEXT_HEADING_REPORTS_FILTER_IFNO', 'Інформація про фільтр');
...
define('TEXT_HEADING_CECK_VERSION', 'Перевірка версії');
...
define('TEXT_LISTING_HORISONTAL_SCROLL', 'Горизонтальна прокрутка списку');
define(
...
define('TEXT_HEADING_GLOBAL_LIST_IFNO', 'Глобальний список');
...
define('TEXT_SAVE_TAMPLATE_NOTE', 'Позначені поля будуть збережені в новий шаблон');
...
define('TEXT_FIELDS_TYPES_GROUP_SPCEIAL_FIELDS', 'Спеціальні');
...
define('TEXT_SELECT_NONOE', 'Зняти виділення');
...
define('TEXT_BUTTON_DB_RESOTRE_FROM_FILE', 'Відновити БД з файлу');
...
define('TEXT_HEADING_ATTACHMENTS_CONFIGURAITON', 'Налаштування вкладень');
...
define('TEXT_ENTER_VALUES_IN_PIXELS_OR_LEAVE_LBANK', 'Введіть розмір в пікселях або залиште поле пустим.');
...
define('TEXT_USER_IS_NOT_FOUD', 'Користувач не знайдений');
...
define('TEXT_DISABLE_HIGHLIGH_UNREAD', 'Відключити виділення непрочитаних записів');
define('TEXT_DISABLE_HIGHLIGH_UNREAD_INFO', 'Буде відключено підсвічування непрочитаних записів.');
...
define('TEXT_FIELDTYPE_BARCODE_DSIPLAY_TIP', 'За замовчуванням при експорті відображається тільки штрих-код');
...
define('TEXT_BUTTON_REGISTRATCION', 'Реєстрація');
...
define('TEXT_REDIRRECTS', 'Переходи');
...
define('TEXT_HIDEN_FIELDS', 'Приховані поля');
define('TEXT_HIDEN_FIELDS_IN_FORM', 'Приховані поля не відображаються у формі');
...
define('TEXT_VIEW_ALL_ACTION_WIDHT_ASSIGNED_ACCESS', 'Перегляд всіх. Дії з призначеними');
define(
...
define('TEXT_FIELDTYPE_MYSQL_QUERY_DINAMIC_QUERY', 'Виконувати динамічно');
define(
...
define('TEXT_HEADING_PATTER_IN_LINSING', 'Шаблон заголовка в списку');
...
define('TEXT_MOVE_TO_PARETN_ITEM_INFO', 'Всі записи будуть переміщені в обраний елемент.');
...
define('TEXT_CHANGE_COL_WIDTH_IN_LISTIN', 'Змінювати ширину стовпчиків в списку');
...
define('TEXT_FIELDTYPE_GOOGLE_MAP_DIRETIONS_TITLE', 'Карта Google маршрути');
define(
...
define('TEXT_FIELDTYPE_GOOGLE_MAP_DIRETIONS_ADDRESS_TIP', 'Введіть декілька адресів з нового рядку.');
define('TEXT_MARKER', 'Маркер');
define('TEXT_LABEL', 'Мітка');
define('TEXT_FIELDTYPE_GOOGLE_MAP_DIRETIONS_LABEL_TIP', 'Ви можете ввести мітки для кожної адреси в новому рядку.');
...
define('TEXT_CHNAGE_EMAIL', 'Змінити адресу електронної пошти');
...
define('TEXT_ERRROR_FILE_NOT_WRITABLE', 'Помилка: файл "%s" недоступний для запису!');
...
define('TEXT_EXTNER_VALUE_IN_PERCENT_OR_PIXELS', 'Введіть значення в процентах або пікселях. Наприклад: 50 або 50%');
...
define('TEXT_KEEP_FIELS', 'Зберігати файли');
