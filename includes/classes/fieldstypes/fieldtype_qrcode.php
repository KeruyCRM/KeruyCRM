...
class fieldtype_qrcode
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_QRCODE_TITLE];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[] = [
            'title' => TEXT_QRCODE_PATTERN . fields::get_available_fields_helper(
                    $_POST['entities_id'],
        ...
        $cfg[] = [
            ...
            'type' => 'dropdown',
            'choices' => [
                'l' => TEXT_CODE_ERROR_CORRECTION_L,
                'm' => TEXT_CODE_ERROR_CORRECTION_M,
                'q' => TEXT_CODE_ERROR_CORRECTION_Q,
                'h' => TEXT_CODE_ERROR_CORRECTION_H
            ],
        ...
        $cfg[] = ['title' => TEXT_HIDE_FIELD_ON_INFO_PAGE, 'name' => 'hide_field_if_empty', 'type' => 'checkbox'];
