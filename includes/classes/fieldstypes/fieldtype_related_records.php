...
class fieldtype_related_records
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_RELATED_RECORDS_TITLE];
    }
    ...
    function get_configuration($params = [])
    {
        ...
        $cfg[TEXT_SETTINGS][] = [
            'title' => tooltip_icon(
                ...
                ) . TEXT_DISPLAY_IN_MAIN_COLUMN,
            'name' => 'display_in_main_column',
            'type' => 'checkbox'
        ];

        $cfg[TEXT_SETTINGS][] = ['title' => TEXT_COLLAPSED, 'name' => 'is_collapsed', 'type' => 'checkbox'];
        $cfg[TEXT_SETTINGS][] = [
            'title' => TEXT_DISPLAY_SEARCH_BAR,
            'name' => 'display_search_bar',
            'type' => 'checkbox'
        ];

        $cfg[TEXT_SETTINGS][] = [
            'title' => TEXT_HIDE_FIELD_IF_NO_RECORDS,
        ...
        $cfg[TEXT_SETTINGS][] = ['name' => 'fields_in_listing', 'type' => 'hidden'];
        $cfg[TEXT_SETTINGS][] = ['name' => 'fields_in_popup', 'type' => 'hidden'];

        $cfg[TEXT_SETTINGS][] = ['name' => 'create_related_comment', 'type' => 'hidden'];
        $cfg[TEXT_SETTINGS][] = ['name' => 'create_related_comment_text', 'type' => 'hidden'];
        $cfg[TEXT_SETTINGS][] = ['name' => 'delete_related_comment', 'type' => 'hidden'];
        $cfg[TEXT_SETTINGS][] = ['name' => 'delete_related_comment_text', 'type' => 'hidden'];
        $cfg[TEXT_SETTINGS][] = ['name' => 'create_related_comment_to', 'type' => 'hidden'];
        $cfg[TEXT_SETTINGS][] = ['name' => 'create_related_comment_to_text', 'type' => 'hidden'];
        $cfg[TEXT_SETTINGS][] = ['name' => 'delete_related_comment_to', 'type' => 'hidden'];
        $cfg[TEXT_SETTINGS][] = ['name' => 'delete_related_comment_to_text', 'type' => 'hidden'];

        //TEXT_FIELDS
        $cfg[TEXT_LINK_RECORD][] = [
    ...
    static function prepare_query_select($entities_id, $listing_sql_query_select, $reports_info = [])
    {
