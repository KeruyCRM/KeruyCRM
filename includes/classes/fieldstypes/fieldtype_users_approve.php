...
class fieldtype_users_approve
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_USERS_APPROVE_TITLE];
    }
    ...
    function get_configuration($params = [])
    {
        ...
        $cfg[TEXT_SETTINGS][] = ['title' => TEXT_HIDE_ADMIN, 'name' => 'hide_admin', 'type' => 'checkbox'];
        $cfg[TEXT_SETTINGS][] = [
        ...
        $cfg[TEXT_BUTTON][] = [
            ...
            'tooltip_icon' => TEXT_DEFAULT . ': ' . TEXT_APPROVE
        ];
        $cfg[TEXT_BUTTON][] = [
            'title' => TEXT_ICON,
            'name' => 'button_icon',
        ...
        $cfg[TEXT_ACTION][] = [
            'title' => TEXT_CONFIRMATION_WINDOW,
        ...
        $cfg[TEXT_ACTION][] = [
            'title' => TEXT_CONFIRMATION_TEXT,
            'name' => 'confirmation_text',
            'type' => 'textarea',
            'params' => ['class' => 'form-control textarea-small'],
            'tooltip_icon' => TEXT_DEFAULT . ': ' . TEXT_ARE_YOU_SURE
        ];

        $cfg[TEXT_ACTION][] = [
            'title' => TEXT_ADD_COMMENT,
            'name' => 'add_comment',
            'type' => 'dropdown',
            'choices' => ['0' => TEXT_NO, '1' => TEXT_YES],
            'params' => ['class' => 'form-control input-small']
        ...
        $cfg[TEXT_ACTION][] = [
            'title' => TEXT_COMMENT_TEXT,
            'name' => 'comment_text',
            'type' => 'textarea',
            'params' => ['class' => 'form-control textarea-small'],
            'tooltip_icon' => TEXT_DEFAULT . ': ' . TEXT_APPROVED
        ];

        $cfg[TEXT_SIGNATURE][] = [
            'title' => TEXT_SIGNATURE,
            'name' => 'use_signature',
            'type' => 'dropdown',
            'choices' => ['0' => TEXT_NO, '1' => TEXT_YES],
            'params' => ['class' => 'form-control input-small']
        ...
        $cfg[TEXT_SIGNATURE][] = [
            'title' => TEXT_WIDTH_IN_ITEM_PAGE,
            'name' => 'signature_width_item_page',
            'type' => 'input',
            'params' => ['class' => 'form-control input-medium'],
            'tooltip_icon' => TEXT_WIDTH_IN_ITEM_PAGE_INFO
        ];
        $cfg[TEXT_SIGNATURE][] = [
            'title' => TEXT_WIDTH_IN_PRINT_PAGE,
            'name' => 'signature_width_print_page',
            'type' => 'input',
            'params' => ['class' => 'form-control input-medium'],
            'tooltip_icon' => TEXT_WIDTH_IN_PRINT_PAGE_INFO
        ];
        ...
        $cfg[TEXT_ACTION][] = [
            'title' => TEXT_ALL_USERS_APPROVED,
            'name' => 'run_process',
            'type' => 'dropdown',
            'choices' => $choices,
            'params' => ['class' => 'form-control input-large'],
            'tooltip' => TEXT_ALL_USERS_APPROVED_INFO
        ];
