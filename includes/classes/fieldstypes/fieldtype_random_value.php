...
class fieldtype_random_value
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_RANDOM_VALUE];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[] = [
            'title' => TEXT_CHARACTERS,
            'name' => 'value_characters',
            'type' => 'textarea',
            'tooltip_icon' => TEXT_CHARACTERS_TIP,
            'params' => ['class' => 'form-control textarea-small'],
            'tooltip' => '~!@#$%^&*()_+abcdefghijkmnopqrstuvwxyz0123456789ABCDEFGHIJKMNOPQRSTUVWXYZ'
        ];
        $cfg[] = [
            'title' => TEXT_SPLIT_VALUE,
            'name' => 'split_value',
            'type' => 'input',
            'tooltip_icon' => TEXT_SPLIT_VALUE_INFO,
            'params' => ['class' => 'form-control input-xsmall']
        ];
        $cfg[] = [
            'title' => TEXT_SPLIT_VALUE_CHAR,
            'name' => 'split_value_char',
            'type' => 'input',
            'tooltip_icon' => TEXT_SPLIT_VALUE_CHAR_INFO,
            'params' => ['class' => 'form-control input-xsmall']
        ];
        $cfg[] = [
            'title' => TEXT_START_ROW,
            'name' => 'start_row',
            'type' => 'input',
            'tooltip_icon' => TEXT_START_ROW_TIP,
