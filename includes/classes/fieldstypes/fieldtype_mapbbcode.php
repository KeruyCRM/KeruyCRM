...
class fieldtype_mapbbcode
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_MAPBBCODE_TITLE];
    }
    ...
    function get_configuration()
    {
        $cfg = [];
        $cfg[] = [
            'title' => TEXT_DEFAULT_POSITION,
            'name' => 'default_position',
            'type' => 'input',
            'tooltip' => TEXT_DEFAULT_POSITION_TIP,
        ...
        $cfg[] = ['title' => TEXT_HIDE_COORDINATES_IN_FORM, 'name' => 'hide_coordinates', 'type' => 'checkbox'];
