...
class fieldtype_stages
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_STAGES_TITLE, 'has_choices' => true];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[TEXT_STAGES_PANEL][] = ['title' => TEXT_COLOR, 'name' => 'color', 'type' => 'colorpicker'];

        $cfg[TEXT_STAGES_PANEL][] = [
            'title' => TEXT_ACTIVE_ITEM_COLOR,
            'name' => 'color_active',
            'type' => 'colorpicker'
        ];

        $cfg[TEXT_STAGES_PANEL][] = [
            'title' => TEXT_ACTION_BY_CLICK,
            'name' => 'click_action',
            'type' => 'dropdown',
            'params' => ['class' => 'form-control input-xlarge'],
            'choices' => [
                '' => '',
                'change_value' => TEXT_ALLOW_CHANGING_VALUE,
                'change_value_next_step' => TEXT_ALLOW_CHANGING_VALUE_NEXT_STEP
            ]
        ];

        $cfg[TEXT_STAGES_PANEL][] = ['title' => TEXT_ADD_COMMENT, 'name' => 'add_comment', 'type' => 'checkbox'];
        ...
        $cfg[TEXT_ACTION][] = ['html' => '<p>' . TEXT_FIELDTYPE_STAGES_ACTION_TIP . '</p>', 'type' => 'html'];
        ...
        if (is_ext_installed()) {
            ...
            $cfg[TEXT_ACTION][] = [
                'html' => '<div class="alert alert-warning">' . TEXT_EXTENSION_REQUIRED . '</div>',
                'type' => 'html'
            ];
        }
