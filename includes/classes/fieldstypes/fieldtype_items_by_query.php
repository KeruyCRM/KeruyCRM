...
class fieldtype_items_by_query
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_ITEMS_BY_QUERY_TITLE];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[TEXT_SETTINGS][] = ['title' => TEXT_DEBUG_MODE, 'name' => 'debug_mode', 'type' => 'checkbox'];

        $cfg[TEXT_DISPLAY_AS][] = [
            'title' => TEXT_IN_ITEM_PAGE,
            'name' => 'display_as',
            'type' => 'dropdown',
            'choices' => ['number' => TEXT_NUMBER_OF_RECORDS, 'list' => TEXT_LIST],
            'default' => 'dropdown',
            'params' => ['class' => 'form-control input-medium']
        ];

        $cfg[TEXT_DISPLAY_AS][] = [
            'title' => TEXT_ITEMS_LISTING,
        ...
        $cfg[TEXT_DISPLAY_AS][] = [
            ...
            'name' => 'default_text',
            'type' => 'input',
            'tooltip' => TEXT_DEFAULT . ': ' . TEXT_TOTAL . ' (#)',
            'params' => ['class' => 'form-control input-medium']
        ];
        ...
        switch ($name) {
            case 'fields_for_search_box':
                ...
                $cfg[] = [
                    ...
                    'name' => 'where_query',
                    'type' => 'textarea',
                    'tooltip' => TEXT_FIELDTYPE_MYSQL_QUERY_WHERE_QUERY_TIP,
