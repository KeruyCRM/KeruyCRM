...
class fieldtype_input_encrypted
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_INPUT_ENCRYPTED_TITLE];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[TEXT_SETTINGS][] = ['type' => 'html', 'html' => $html];
        ...
        $cfg[TEXT_HIDE_VALUE][] = ['title' => TEXT_HIDE_VALUE, 'name' => 'hide_value', 'type' => 'checkbox'];
    ...
    static function decrypt_value($value)
    {
        ...
        if (!ctype_print($value)) {
            $value_query = db_query(
                "select AES_DECRYPT('" . db_input($value) . "','" . db_input(DB_ENCRYPTION_KEY) . "') as text",
                false
            );
