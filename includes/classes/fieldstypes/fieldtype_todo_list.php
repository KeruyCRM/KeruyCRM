...
class fieldtype_todo_list
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_TODO_LIST_TITLE];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[] = [
            'title' => TEXT_USE_COMMENTS,
            'name' => 'use_comments',
            'type' => 'dropdown',
            'params' => ['class' => 'form-control input-large'],
            'choices' => ['' => '', 'auto' => TEXT_AUTO_ADD_COMMENT, 'form' => TEXT_OPEN_COMMENT_FORM],
            'tooltip_icon' => TEXT_FIELDTYPE_TODO_LIST_USE_COMMENTS_INFO
        ];

        $cfg[] = [
            'title' => TEXT_FOR_SUCCESSFUL_CHECK,
            'name' => 'text_check',
            'type' => 'input',
            'params' => ['class' => 'form-control input-large']
        ];
        $cfg[] = [
            'title' => TEXT_FOR_UNCHECK,
            'name' => 'text_unckeck',
            'type' => 'input',
            'params' => ['class' => 'form-control input-large']
        ];

        $cfg[] = ['title' => TEXT_HIDE_CHECKBOXES_IF_NO_ACCESS, 'name' => 'hide_checkboxes', 'type' => 'checkbox'];
