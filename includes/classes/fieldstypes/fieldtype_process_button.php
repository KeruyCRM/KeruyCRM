...
class fieldtype_process_button
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_PROCESS_BUTTON_TITLE];
    }
        ...
        if (is_ext_installed()) {
            ...
            $cfg[] = [
                ...
                'choices' => [
                    ...
                    'inrow' => TEXT_EXT_EXTRA_ROWS,
                    'grouped' => TEXT_EXT_BUTTON_GROUP,
            ...
            $cfg[] = [
                ...
                'type' => 'input',
                'params' => ['class' => 'form-control input-medium'],
                'tooltip' => TEXT_DEFAULT . ': ' . TEXT_ACTION,
                'form_group' => ['form_display_rules' => 'fields_configuration_display_as:dropdown']
            ];

            $cfg[] = [
                'title' => TEXT_EXT_PROCESS_BUTTON_COLOR,
                'name' => 'button_color',
                'type' => 'colorpicker',
                'form_group' => ['form_display_rules' => 'fields_configuration_display_as:dropdown']
            ];
        } else {
            $cfg[] = ['html' => app_alert_warning(TEXT_EXTENSION_REQUIRED), 'type' => 'html'];
        }
