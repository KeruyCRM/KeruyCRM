...
class fieldtype_phone
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_PHONE];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[TEXT_SETTINGS][] = [
            ...
            'name' => 'mask',
            'type' => 'input',
            'tooltip_icon' => TEXT_INPUT_FIELD_PHONE_MASK_TIP,
        ...
        if (is_ext_installed()) {
            ...
            $cfg[TEXT_EXT_TELEPHONY_MODULE][] = [
                'title' => TEXT_EXT_TELEPHONY_MODULE,
                'name' => 'telephony_module',
                'type' => 'dropdown',
                'choices' => ['' => ''] + $choices,
                'tooltip_icon' => TEXT_EXT_FIELDTYPE_PHONE_TELEPHONY_MODULE_INFO,
                'params' => ['class' => 'form-control input-large']
            ];
            ...
            $cfg[TEXT_EXT_TELEPHONY_MODULE][] = [
                'title' => TEXT_EXT_SMS_MODULE,
                'name' => 'sms_module',
                'type' => 'dropdown',
                'choices' => ['' => ''] + $choices,
                'tooltip_icon' => TEXT_EXT_FIELDTYPE_PHONE_SMS_MODULE_INFO,
                'params' => ['class' => 'form-control input-large']
            ];

            $cfg[TEXT_EXT_TELEPHONY_MODULE][] = [
                'title' => TEXT_EXT_SHOW_CALL_SMS_HISTORY,
                'name' => 'show_history',
                'type' => 'checkbox'
            ];
        }
...
END";
    ...
    function output($options)
    {
        ...
        if (strlen($cfg->get('sms_module'))) {
            ...
            if ($module_info = db_fetch_array($module_info_query)) {
                $phone_number .= '&nbsp;&nbsp;<a title="' . TEXT_EXT_SMS . '" href="javascript: open_dialog(\'' . url_for(
                        'items/send_sms',
        ...
        if ($cfg->get('show_history')) {
            $phone_number .= '&nbsp;&nbsp;<a title="' . TEXT_EXT_HISTORY . '" href="javascript: open_dialog(\'' . url_for(
                    'items/call_history',
