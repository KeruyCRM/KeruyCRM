...
class fieldtype_input_vpic
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_INPUT_VPIC_TITLE];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[] = [
            'title' => TEXT_VPIC_AUTO_FILL_FIELDS,
            'name' => 'auto_fill_fields',
            'type' => 'checkbox',
            'tooltip_icon' => TEXT_VPIC_AUTO_FILL_FIELDS_TIP
        ];

        $cfg[] = [
            'title' => TEXT_VPIC_OTHER_DETAILS,
            'name' => 'other_details',
            'type' => 'input',
            'tooltip_icon' => TEXT_VPIC_OTHER_DETAILS_TIP,
