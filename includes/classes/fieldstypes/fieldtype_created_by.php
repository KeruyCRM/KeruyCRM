...
class fieldtype_created_by
{
    ...
    {
        $this->options = ['name' => TEXT_FIELDTYPE_CREATEDBY_TITLE, 'title' => TEXT_FIELDTYPE_CREATEDBY_TITLE];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[] = ['title' => TEXT_DISABLE_NOTIFICATIONS, 'name' => 'disable_notification', 'type' => 'checkbox'];
