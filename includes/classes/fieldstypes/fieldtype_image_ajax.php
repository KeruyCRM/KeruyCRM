...
class fieldtype_image_ajax
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_IMAGE_AJAX_TITLE];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[] = ['title' => TEXT_ALLOW_CHANGE_FILE_NAME, 'name' => 'allow_change_file_name', 'type' => 'checkbox'];
        $cfg[] = [
        ...
        $cfg[] = [
            'title' => TEXT_PREVIEW_IMAGE_SIZE,
            'name' => 'width',
            'type' => 'input',
            'tooltip_icon' => TEXT_PREVIEW_IMAGE_SIZE_TIP,
