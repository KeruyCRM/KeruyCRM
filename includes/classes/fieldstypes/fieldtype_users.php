...
class fieldtype_users
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_USERS_TITLE];
    }
    ...
    function get_configuration($params = [])
    {
        ...
        $cfg[TEXT_EXTRA][] = ['title' => TEXT_HIDE_ACCESS_GROUP, 'name' => 'hide_access_group', 'type' => 'checkbox'];
        $cfg[TEXT_EXTRA][] = [
            'title' => TEXT_USERS_GROUPS,
            'name' => 'use_groups',
            'type' => 'dropdown',
            'choices' => access_groups::get_choices(false),
            'tooltip_icon' => TEXT_USE_GROUPS_TIP,
