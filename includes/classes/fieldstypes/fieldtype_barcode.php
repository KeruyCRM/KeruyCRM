...
class fieldtype_barcode
{
    ...
    {
        $this->options = ['title' => TEXT_FIELDTYPE_BARCODE_TITLE];
    }
    ...
    function get_configuration()
    {
        ...
        $cfg[TEXT_BARCODE][] = [
            'title' => TEXT_FIELDTYPE_BARCODE_TYPE,
            'name' => 'barcode_type',
            'type' => 'dropdown',
            'choices' => $choices,
            'default' => 'TYPE_CODE_128',
            'tooltip_icon' => TEXT_FIELDTYPE_BARCODE_ACCEPTED_TYPE_TIP,
            'params' => ['class' => 'form-control input-medium chosen-select']
        ];

        $cfg[TEXT_BARCODE][] = [
            'title' => TEXT_FIELDTYPE_BARCODE_METHOD_GENERATING . fields::get_available_fields_helper(
                    $_POST['entities_id'],
        ...
        $cfg[TEXT_EXPORT][] = [
            ...
            'name' => 'height',
            'type' => 'input',
            'tooltip_icon' => TEXT_FIELDTYPE_BARCODE_HEIGHT_TIP,
