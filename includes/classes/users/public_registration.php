...
class public_registration
{
    ...
    {
        //skip notification
        if (CFG_USE_PUBLIC_REGISTRATION == 0 or CFG_PUBLIC_REGISTRATION_USER_ACTIVATION != 'manually') {
            return false;
        }
        ...
        if ($previous_item_info['field_5'] == 0) {
            ...
            if ($item = db_fetch_array($item_query)) {
                ...
                $options = [
                    ...
                    ) > 0 ? CFG_USER_ACTIVATION_EMAIL_SUBJECT : TEXT_USER_ACTIVATION_EMAIL_SUBJECT),
                    'body' => (strlen(CFG_USER_ACTIVATION_EMAIL_BODY) > 0 ? CFG_USER_ACTIVATION_EMAIL_BODY : sprintf(
                        TEXT_USER_ACTIVATION_EMAIL_BODY,
