;(function () {
    ...
    var error_msg_plugin_is_not_available = '<b>Ошибка:</b> КриптоПро плагин недоступен. Для корректной работы приложения необходимо скачать и установить плагин <a href="https://www.cryptopro.ru/downloads" target="_blank">КриптоПро ЭЦП Browser plug-in</a>.'
    ...
    function show_firefox_missing_extension_dialog()
    {
        if (!window.cadesplugin_skip_extension_install)
        {
            ...
            {
                plugin_loaded_error(error_msg_plugin_is_not_available);
    ...
    function plugin_loaded_error(msg)
    {
        ...
        if(typeof(msg) === 'undefined' || typeof(msg) === 'object')
            msg = error_msg_plugin_is_not_available;
        plugin_resolved = 1;
        if(canPromise)
        {
            plugin_reject('<div class="alert alert-danger">'+msg+'</div>');
        } else {
