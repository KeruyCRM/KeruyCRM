...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      //set color            
      if(option.classes.search('#')!=-1)
      {
        option_el.innerHTML = '<span class="choices-color" style="background: '+option.classes+'"></span>'+option.html;
      }
  ...
  Chosen = (function(superClass) {
    ...
    Chosen.prototype.choice_build = function(item) {
      ...
      if(item.classes.search('#')!=-1)
      {
        color_html = '<span class="choices-color" style="background: '+item.classes+'"></span>';
      }
      
      
      choice = $('<li />', {
        "class": "search-choice"
      }).html(color_html+"<span>" + (this.choice_label(item)) + "</span>");
      if (item.disabled) {
    ...
    Chosen.prototype.single_set_selected_text = function(text,item) {
      ...
      if(typeof item !== 'undefined') 
      {
        if(item.classes.search('#')!=-1)
        {
          text = '<span class="choices-color" style="background: '+item.classes+'"></span>'+text;
        }
      }
